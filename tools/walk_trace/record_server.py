"""Run with python -m tools.walk_trace.record_server; binds loopback only."""
...
from tools.walk_trace.lab import router as trace_router
...
def create_app(cache: Path, key: str = ""):
    ...
    @app.get("/")
    def view():
        return FileResponse(ROOT / "tools/walk_trace/static/walk_record_lab.html")
