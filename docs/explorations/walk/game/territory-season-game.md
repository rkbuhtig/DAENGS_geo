...
> 기본 100점 한도 + 매 탈취 20점, 시간당 2/10점, 계수 없음으로 확정했다.
> 아래 배점·계수·7일 시즌은 기존 로컬 실험 설명이며 새 정책 구현 완료를 뜻하지 않는다.
> 인증 보호 기반은 [정책 v2](../../../territory-policy-v2.md), 새 보상·유지 기간은 위 합의를 따른다.
