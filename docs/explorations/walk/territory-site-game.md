...
> **2026-09-05 제작 방향 갱신:** [제작 계획](territory-production-plan.md)은 사진 없는 점유를
> 허용하고 인증 점유에 우선권을 둔다. 아래 사진 필수 흐름은 이전 탐색이며, 현재 제작에서는
> 미인증 점유와 같은 시도의 인증 강화를 구분한다. 세션별 점령 규칙과 구현 순서는 제작 계획을 따른다.
