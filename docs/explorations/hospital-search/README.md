...
| [kakao-category](kakao-category.md) | exploring | none | 카카오 로컬 `category_name`으로 과목 보강. 미저장 |
| [community-search](community-search.md) | parked | draft | 쿼리 재작성·fake 매칭만 존재. 실제 NAVER 검색 미구현 |
...
| [homepage-enrich](homepage-enrich.md) | parked | none | 병원 홈페이지에서 진료시간·과목 온디맨드 추출 |
