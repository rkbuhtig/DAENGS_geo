...
제품 축은 [결정 #65](decisions/2026-08-26-place-first-discovery.md), 현재 구현 조립의 기준은
...
- [원좌표를 지우면 무엇을 남기나 — 궤적 후보는 추정의 14배(대부분 GPS 지터), 집계만 남겨도 순서가 우연의 18배로 남는다](research/2026-08-26-storage-candidates.md)
