...
- [2026-09-04 APP GPS·점령지 Lab 설계와 인수인계](research/2026-09-04-walk-territory-lab-handoff.md) — debug 재생 격리, 도착/액션/소유 표시 분리, 반경 UX, 코드 지도, 다른 PC 실행과 미완료 검증. 문서는 Geo, 구현은 APP feature 브랜치
