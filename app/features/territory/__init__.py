...
(결정 #51), 소비자가 규칙과 버전을 달고 만든다.
    ...
    continuous_brush.py 육각 격자 없이 같은 붓을 읽는 연속 reference field
    ...
    spatial_diary.py Capsule을 기간·문맥으로 고르고 field+receipt로 조립하는 읽기층
    api.py       SpatialDiaryView v0 HTTP 질의 표면
